...
;  Letters, third row
 ...
 SC2c::SendKey("U+007a", Map("**", "U+00e6", "*´", "U+017a", "*^", "U+1e91", "*ˇ", "U+017e", "*/", "U+01b6", "*˙", "U+017c", "*µ", "U+03b6")) ; z
+SC2c::SendKey("U+005a", Map("**", "U+00c6", "*´", "U+0179", "*^", "U+1e90", "*ˇ", "U+017d", "*/", "U+01b5", "*˙", "U+017b", "*µ", "U+0396")) ; Z

 SC2d::SendKey("U+0078", Map("**", "U+00df", "*¨", "U+1e8d", "*˙", "U+1e8b", "*µ", "U+03be")) ; x
+SC2d::SendKey("U+0058", Map("**", "U+1e9e", "*¨", "U+1e8c", "*˙", "U+1e8a", "*µ", "U+039e")) ; X

 SC2e::SendKey("U+002d", Map("**", "U+2011", "*^", "U+207b", "*ˇ", "U+208b")) ; -
+SC2e::SendKey("U+003f", Map("**", "U+00bf")) ; ?

 SC2f::SendKey("U+0076", Map("**", "U+2013", "*~", "U+1e7d")) ; v
+SC2f::SendKey("U+0056", Map("*~", "U+1e7c")) ; V

 SC30::SendKey("U+0062", Map("**", "U+2014", "*/", "U+0180", "*˙", "U+1e03", "*µ", "U+03b2", "*¤", "U+0e3f")) ; b
+SC30::SendKey("U+0042", Map("*/", "U+0243", "*˙", "U+1e02", "*µ", "U+0392", "*¤", "U+20b1")) ; B
...
+SC2b::SendKey("U+007c", Map()) ; |
 ...
 SC56::SendKey("U+003c", Map("*~", "U+2272", "*/", "U+226e")) ; <
+SC56::SendKey("U+003e", Map("*~", "U+2273", "*/", "U+226f")) ; >
...
;  Letters, third row
 ...
 <^>!SC2c::SendKey("U+007e", Map()) ; ~
<^>!+SC2c::SendKey("*~", Map("*~", "~"))

 <^>!SC2d::SendKey("U+005b", Map()) ; [
<^>!+SC2d::SendKey("*,", Map("*,", ","))

 <^>!SC2e::SendKey("U+005d", Map()) ; ]
<^>!+SC2e::SendKey("*˛", Map("*˛", "˛"))

 <^>!SC2f::SendKey("U+005f", Map("**", "U+2013")) ; _
<^>!+SC2f::SendKey("U+2013", Map()) ; –

 <^>!SC30::SendKey("U+0023", Map()) ; #
